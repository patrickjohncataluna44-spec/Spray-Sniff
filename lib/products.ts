...
export const products: Product[] = [
  {
    id: 'test-1peso',
    name: 'Test Perfume 1 Peso',
    brand: SITE_NAME,
    description: 'A 1 peso test perfume for verifying checkout and payment flows without tax.',
    price: 1,
    category: 'Eau de Parfum',
    scentFamily: ['Fresh', 'Test'],
    gender: 'unisex',
    topNotes: ['Bergamot'],
    middleNotes: ['White Tea'],
    baseNotes: ['Soft Musk'],
    longevity: 3,
    intensity: 1,
    sizes: [{ ml: 30, price: 1 }],
